        ...
        return (
            ...
            <div className="flex flex-col justify-center items-center lg:flex-row py-12">
                    ...
                    <div className="p-6 flex flex-col w-4/5">
                        ...
                        {engLang == true ? <p className="font-sans">Former Urban Designer who loves to explore the world Interested in human behavior design And national development strategy It is believed that every change starts with a small droplet flowing together.</p> : <p className="font-sans">อดีต Urban Designer ผู้รักการเดินทางสำรวจโลกกว้าง สนใจงานออกแบบเชิงพฤติกรรมมนุษย์ และยุทธศาสตร์การพัฒนาประเทศ เชื่อว่าทุกการเปลี่ยนแปลงเริ่มต้นจากน้ำหยดเล็กที่ไหลมารวมกัน</p>}
                    </div>
            </div>
            </>
        )
