    ...
    const index = parseInt(num) - 1;
        return (
            <div className="w-full flex flex-col items-center font-sans">
                <p className="flex font-sans">Write something for Paragraph Number {`${num}`}</p>
                <textarea className="leading-normal font-sans border-2 rounded-md text-center w-full h-72 p-3 my-3" placeholder={`Body Paragraph No. ${num}`} name="body3" onChange={handleChange}/>
