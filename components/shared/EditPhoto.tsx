    ...
    if (!willUpload) {
        return (
            <div className="flex flex-col items-center">
                ...
                <button className="focus:outline-none focus:ring max-w-lg focus:border-gray-300 bg-blue hover:bg-yellow-500 text-white hover:text-red-500 rounded-full font-bold px-4 py-3 transition duration-300 ease-in-out mr-6" onClick={() => setWillUpload(true)} >Replace Photo</button>
            </div>
    )
    } else {
        return (
