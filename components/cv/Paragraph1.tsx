...
const Paragraph1: React.FC<Props> = props => {
        ...
        return (
            ...
            <div className="flex flex-col justify-center items-center md:flex-row p-6">
                <div className="md:min-w-max w-auto"><img className="w-64 md:max-h-52 min-h-32" src="https://ming-portfolio-uploads.s3.ap-northeast-2.amazonaws.com/cliff.jpg" alt=""/></div>
                    <div className="p-6">
